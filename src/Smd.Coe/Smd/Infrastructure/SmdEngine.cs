...
using Smd.Infrastructure.Mapper;
using AutoMapper;

namespace Smd.Infrastructure
{
    /// <summary>
    /// Represents Smd engine
    /// </summary>
    public class SmdEngine : IEngine
    {
        #region Properties
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            CommonHelper.DefaultFileProvider = new SmdFileProvider(hostingEnvironment);

            //initialize plugins
            var nopConfig = provider.GetRequiredService<SmdConfig>();
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<ISmdStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                //.Where(startup => PluginManager.FindPlugin(startup)?.Installed ?? true) //ignore not installed plugins
                .Select(startup => (ISmdStartup)Activator.CreateInstance(startup))
            ...
            var nopConfig = services.BuildServiceProvider().GetService<SmdConfig>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new SmdException("Unknown dependency");
                        return service;
                    });
            ...
            throw new SmdException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
