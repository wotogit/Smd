...
namespace Smd.Authorization.Users
{
    ...
    public class UserAccountSynchronizer :
        IEventHandler<EntityCreatedEventData<SmdUserBase>>,
        IEventHandler<EntityDeletedEventData<SmdUserBase>>,
        IEventHandler<EntityUpdatedEventData<SmdUserBase>>,
        ITransientDependency
    {
        ...
        /// </summary>
        [UnitOfWork]
        public virtual void HandleEvent(EntityCreatedEventData<SmdUserBase> eventData)
        {
        ...
        [UnitOfWork]
        public virtual void HandleEvent(EntityDeletedEventData<SmdUserBase> eventData)
        {
            using (_unitOfWorkManager.Current.SetTenantId(null))
            {
                var userAccount =
        ...
        /// <param name="eventData"></param>
        [UnitOfWork]
        public virtual void HandleEvent(EntityUpdatedEventData<SmdUserBase> eventData)
        {
            using (_unitOfWorkManager.Current.SetTenantId(null))
            {
