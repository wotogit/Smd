...
{
    public class SmdSignInManager<TRole, TUser> : SignInManager<TUser>, ITransientDependency
     ...
     where TUser : SmdUser<TUser>
    {
        ...
        //    return SmdZeroClaimsIdentityHelper.GetTenantId(result.Principal);
        //}
        ...
        public override async Task RememberTwoFactorClientAsync(TUser user)
        {
            ...
            //{
            //    rememberBrowserIdentity.AddClaim(new Claim(SmdClaimTypes.TenantId, user.TenantId.Value.ToString()));
            //}
