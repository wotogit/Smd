...
namespace Smd.Authorization.Users
{
        ...
        where TUser : SmdUser<TUser>
    {
        ...
        public ISmdSession AbpSession { get; set; }
        ...
        private readonly IRepository<UserPermission, long> _userPermissionSettingRepository;
      ...
      //  private readonly IUnitOfWorkManager _unitOfWorkManager;
            ...
            IRepository<UserPermission, long> userPermissionSettingRepository)
        {
            ...
            AbpSession = NullSmdSession.Instance;
        ...
        public virtual Task<TUser> FindByNameAsync([NotNull] string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return UserRepository.FirstOrDefaultAsync(u => u.UserName == normalizedUserName);
        }
        ...
        public virtual async Task AddLoginAsync([NotNull] TUser user, [NotNull] UserLoginInfo login, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            user.Logins.Add(new UserLogin(user.Id, login.LoginProvider, login.ProviderKey));
        }
       ...
       // [UnitOfWork]
        ...
        public virtual Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return UserRepository.FirstOrDefaultAsync(u => u.EmailAddress == normalizedEmail);
        }
